...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, HttpClientModule, ButtonComponent, MatIcon],
...
export class HostGroupingComponent implements OnInit {
  ...
  public groupEmojis = [
    ...
    '🖌️', // Paintbrush
    '🔬', // Microscope
    '🌟', // Star (for excellence or creativity)
  ];
    ...
    this.firestore
      ...
      .subscribe(
        ...
        (error) => {
          ...
          this.errorMessage =
            'Si è verificato un errore durante il recupero dei gruppi.';
          this.isLoading = false;
        }
      );
  }
      ...
      .subscribe(
        async (groupSnapshots) => {
          ...
          const logoBlob = await firstValueFrom(
            this.http.get('assets/images/bozzalogo_ver2.png', {
              responseType: 'blob',
            })
          );
